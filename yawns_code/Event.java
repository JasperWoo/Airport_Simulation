...
public class Event implements Comparable<Event> {
    ...
    Event(double delay, EventHandler handler, int eventType) {
        this();     //Implements the constructor without parameter, which assigns an eventIndex.
        m_time = delay;
        m_handler = handler;
    ...
    //Once the event is constructed, isn't it unnecessary for us to set another Handler? What is this method for?
